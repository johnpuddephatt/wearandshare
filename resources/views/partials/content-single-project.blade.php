<article @php(post_class())>
  ...
  <div class="wp-block alignfull relative flex min-h-[90vh] flex-col justify-center overflow-hidden bg-blue">
    ...
    <div class="w-header container relative z-10 flex flex-col items-center justify-between gap-8 py-24 lg:flex-row">
      <div>
        <h2 class="project-title type-2xl mb-4 max-w-3xl uppercase lg:mb-6">
          {!! $wrapped_title !!}
        </h2>
      ...
      @if (get_field('project_image', $post->ID))
        <div class="relative z-10 max-w-sm 2xl:max-w-md">

          {!! wp_get_attachment_image(get_field('project_image', $post->ID), 'square', null, [
    ...
    <svg class="absolute right-0 h-[calc(100%+8rem)] lg:-top-32" xmlns="http://www.w3.org/2000/svg"
